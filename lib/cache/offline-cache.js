...
exports.WRITE_ACTION = 'AAS_WRITE';
var MyCache = /** @class */ (function (_super) {
    ...
    function MyCache(store, config) {
        ...
        _this.store = store;
        _this.cancelSubscription = store.subscribe(function () {
...
var writeThunk = function (payload) { return function (dispatch) {
    dispatch({
        type: exports.WRITE_ACTION,
        payload: payload,
    });
}; };
