 ...
 */
var newStore = function (clientGetter, persistCallback, conflictResolver) {
    ...
    return redux_1.createStore(redux_1.combineReducers(__assign({ rehydrated: function (state, action) {
        ...
        }, effect: function (effect, action) { return offline_link_1.offlineEffect(clientGetter(), effect, action); }, discard: offline_link_1.discard(conflictResolver) }))));
};
